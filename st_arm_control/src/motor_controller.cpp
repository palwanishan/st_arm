...
Motor_Controller::Motor_Controller()
{
  ...
  _DEV_MC[0].SetMotorControllerId(0);   _DEV_MC[0].SetCanShieldChannel(0);
  _DEV_MC[1].SetMotorControllerId(1);   _DEV_MC[1].SetCanShieldChannel(0);
  _DEV_MC[2].SetMotorControllerId(2);   _DEV_MC[2].SetCanShieldChannel(0);
}
